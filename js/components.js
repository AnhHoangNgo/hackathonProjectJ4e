...
<div class="container">
<div class="left">
    <a href="?page=home" class="logo"><img src="../hackathonProjectJ4e/image/logo.png" alt="logo"></a>
    <div class="hm-menu">
        <span></span>
        <span></span>
        <span></span>
...
<header class="headerPage">
     ...
     <div class="model">
     <img class="logoModel" src="https://www.lamborghini.com/sites/it-en/files/DAM/lamborghini/gateway-models/urus/Urus-logo-2.png">
     ...
     <div class="model">
     <img class="logoModel" src="https://www.lamborghini.com/sites/it-en/files/models_gateway/logo-huracan.png">
     <p>From our past, we've learned perfection. This is how the first model of the Lamborghini Huracán was born. 
     More performance, more control, more innovation. The Huracán is equipped with a powerful V10 engine and the 
     latest technologies to perform at its absolute best. Engineered to guarantee the best performance and control
      under any driving condition, it's easy to take to the limit, not to mention extremely fun, thanks to technology
     ...
     <div class="model">
     <img class="logoModel" src="https://www.lamborghini.com/sites/it-en/files/DAM/lamborghini/gateway-family/aventador/logo-aventador.png">
